...
const NavAcademic = () => {
  ...
  const Menus = [
    {
      title: "Dashboard",
      url: "/NavAcademic/DashboardAcademic",
      src: Dashboard,
    },
    { title: "Student", url: "/NavAcademic/StudentAcademic", src: Avatar },
    // { title: "Library", url: "/Nav/Library", src: Search },
    // { title: "Profile", url: "/NavAcademic/ProfileAcademic", src: Man },
    ...
    <>
      <div className="">
        <div className=" shadow-md w-full  top-0 left-0 ">
          <div className="md:flex items-center justify-between bg-gradient-to-r from-blue-500 to-purple-600 py-3 md:px-10 px-7">
            <div>
        ...
        <div className="flex  ">
          <div
            className={` ${
              open ? "w-60 " : "w-20 "
            } bg-gradient-to-r from-blue-500 to-purple-600 h-screen p-5  pt-8 relative duration-300`}
          >
            <img
              src={Image}
