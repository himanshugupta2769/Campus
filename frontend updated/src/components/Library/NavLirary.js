...
const NavLirary = () => {
  ...
  const Menus = [
    {
      title: "Dashboard",
      url: "/NavLirary/DashboardLirary",
      src: Dashboard,
    },
    { title: "Student", url: "/NavLirary/StudentLirary", src: Avatar },

    { title: "Book", url: "/NavLirary/StudentLiraryBook", src: Man },
