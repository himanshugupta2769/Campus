...
const Updateuser = () => {
  ...
  useEffect(() => {
   ...
   const handleSubmit = (e) => {
    ...
    if (/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(udateData.email)) {
      axios
        ...
        <div class="max-w-screen-md mx-auto p-5">
          <div class="text-center mb-16">
            <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
              Update <span class="text-indigo-600">User</span>
            </h3>
          </div>
          <form class="w-full">
              ...
              <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <div class="relative">
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="">{udateData.role}</option>
                    <option value="academics">Academic</option>
                    <option value="accoutant">Accountant</option>
                  </select>
                ...
                {/* <div class="relative">
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="">{dataUpdate.branch}</option>
